...
<head>
    ...
    <title>Privacy Policy - UTM Commerce Connect</title>
...
<body>
    ...
    <div class="container">
        ...
        <p>
            We value your privacy. UTM Commerce Connect collects and uses your information only for providing and improving our services. We do not share your personal data with third parties except as required by law.
        </p>
        <ul>
            <li>Your data is stored securely and used only for order processing and communication.</li>
            <li>You may request deletion of your account and data at any time.</li>
            <li>We may update this policy as needed. Please review it regularly.</li>
        </ul>
    </div>
