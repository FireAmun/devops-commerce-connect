...
<body>
    <div class="main-container">
        <div class="left-panel">
            ...
            <h2>Welcome, Admin!</h2>
            <p>UTM Commerce Connect is your gateway to managing the platform and overseeing operations. Access your admin dashboard to monitor vendors, manage users, and ensure smooth platform operations.</p>
        </div>
