...
<head>
    ...
    <title>Contact - UTM Commerce Connect</title>
...
<body>
    ...
    <div class="container">
        <h1>Contact Us</h1>
        <p>For any inquiries or support, please reach out to us through any of the following channels:</p>

        <div class="contact-info">
            <div class="contact-card">
                <i class="fas fa-envelope"></i>
                <h3>Email</h3>
                <p>utmcommerceconnect@gmail.com</p>
            </div>
            <div class="contact-card">
